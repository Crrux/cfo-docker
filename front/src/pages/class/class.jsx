      ...
      <section className="collapsible_container">
        <div className="collapsible_container__column">
          <Collapsible
              ...
              titre={"LE WOD"}
          >
            <p>Le WOD est l&apos;acronyme de Workout of The Day. </p>
            <p>Chaque jour, une
          ...
          >
            <p>
              Notre séance de renforcement global,
              alliant exercices au poids de corps et à charges externes.
            </p>
            <p>
              Ses
          ...
          >
            <p>La gym&apos; pratiquée en CrossFit regroupe tous les
              ...
              marche sur les mains et bien d&apos;autres…</p>
            <p>Il est destiné à l&apos;apprentissage technique des
              mouvements les plus simples aux plus complexes.</p>
            <p>
              Ce cours favorise le
          ...
          >
            <p>Weightlifting est une discipline olympique composée de deux mouvements
              ...
              l&apos;explosivité, l&apos;agilité et la coordination.</p>
            <p>Un cours pour
        ...
        <div className="collapsible_container__column">
          ...
          >
            <p>
              CrossFit Kids / Teens est destiné aux enfants de 7 à 11 et de 12 à 17
              ...
              posture, grimper, sauter, ramper, tirer, pousser, lancer, etc…
            </p>
            <p>
              En plus
          ...
          >
            ...
            <p>
              Son but est de renforcer vos liens dans un
              environnement positif et de se dépasser en famille.
            </p>
            <p>
              Ensemble, vous prenez soin de votre santé et nourrissez une complicité durable.
            </p>
          ...
          >
            <p>
              ...
              l&apos;âge et conserver une santé de fer.
            </p>
            <p>
              En petits groupes, au
              travers de mouvements fonctionnels, dans une ambiance bienveillante et
              chaleureuse.
            </p>
            <p>À partir de 65 ans !</p>
          </Collapsible>
          <Collapsible
              index={9}
              titre={"LE WOD TEAM"}
          >
            <p>
              ...
              les points forts et les appétences de chacun !
            </p>
            <p>
          ...
          <Collapsible index={10} titre={"Pilates"}>
            <p>Le Pilates est une méthode douce mais efficace de renforcement musculaire axée sur la posture, la respiration et le contrôle du mouvement.</p>
            <p>Ce cours vous aide à développer votre sangle abdominale, à améliorer votre souplesse, votre mobilité articulaire et à prévenir les douleurs liées aux déséquilibres posturaux.</p>
            <p>Idéal en complément d’un entraînement plus intense, le Pilates convient à tous les niveaux et s’intègre parfaitement dans une routine bien-être ou de récupération active.</p>
          </Collapsible>
        </div>
      </section>
